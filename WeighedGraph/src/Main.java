...
public class Main {
    public static void main(String[] args) {
        WeightedGrade wg = new WeightedGrade(); //create an object of class WeightGrade
        ...
        wg.calculateGrade(list1, list2, list3);    //calculates the total weighted grade and stores in array
        double result = wg.calculateTotal();      //add array elements to calculate the total and multiply by 100
